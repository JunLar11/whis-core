...
class StencilEngine implements ViewEngine
{
    ...
    protected function compile($file, $layout = null)
    {
        ...
        if (! file_exists("{$this->viewsPath}/{$file}.html")) {
            throw new HttpNotFoundException("View not found: {$this->viewsPath}/{$file}.html");
        }
    ...
    protected function compileCode($code)
    {
        ...
        /*
     * Debe ir antes de compileEscapedEchos(), compileEchos() y compilePHP(),
     * porque aquí vamos a inyectar PHP directamente.
     */
